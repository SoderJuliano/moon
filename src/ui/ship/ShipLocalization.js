...
export const TRANSLATIONS = {
  pt: {
    ...
    ships: {
      ...
      naveSW: {
        name: "Caça Estelar SW-X",
        registry: "REGISTRY // T-65 PROTO",
        story: "Caça estelar lendário de alta manobrabilidade. Equipado de série com 4 canhões de plasma montados nas asas (1 tiro por asa) e 5 propulsores iônicos (4 auxiliares e 1 central de alto empuxo). Desbloqueado após abater pelo menos 20 inimigos na área de combate.",
      },
    },
    ...
    lockedNoticeKills: "🔒 Bloqueado: Abata pelo menos 20 inimigos em combate para desbloquear ({kills}/{required} abatidos)",
  ...
  en: {
    ...
    ships: {
      ...
      naveSW: {
        name: "SW-X Starfighter",
        registry: "REGISTRY // T-65 PROTO",
        story: "Legendary high-maneuverability starfighter. Factory-equipped with 4 wing-mounted plasma cannons (1 shot per wing) and 5 ion thrusters (4 aux and 1 high-thrust central engine). Unlocked after defeating at least 20 enemies in the combat area.",
      },
    },
    ...
    lockedNoticeKills: "🔒 Locked: Defeat at least 20 enemies in combat to unlock ({kills}/{required} destroyed)",
